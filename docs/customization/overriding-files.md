...
You can now override all methods from the [VoyagerBaseController](https://github.com/monstrex/voyager/blob/1.81/src/Http/Controllers/VoyagerBaseController.php)
